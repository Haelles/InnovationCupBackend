...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(700, 360, 81, 27))
        ...
        self.pushButton_10.setGeometry(QtCore.QRect(130, 40, 97, 27))
        self.pushButton_10.setObjectName("pushButton_10")
        self.pushButton_11 = QtWidgets.QPushButton(Form)
        self.pushButton_11.setGeometry(QtCore.QRect(10, 40, 97, 27))
        self.pushButton_11.setObjectName("pushButton_11")
        self.pushButton_12 = QtWidgets.QPushButton(Form)
        self.pushButton_12.setGeometry(QtCore.QRect(800, 10, 97, 27))
        self.pushButton_12.setObjectName("pushButton_12")
        self.pushButton_13 = QtWidgets.QPushButton(Form)
        self.pushButton_13.setGeometry(QtCore.QRect(800, 40, 97, 27))
        self.pushButton_13.setObjectName("pushButton_13")



        self.graphicsView = QtWidgets.QGraphicsView(Form)
        self.graphicsView.setGeometry(QtCore.QRect(20, 120, 320, 512))
        self.graphicsView.setObjectName("graphicsView")

        self.graphicsView_stroke = QtWidgets.QGraphicsView(Form)
        self.graphicsView_stroke.setGeometry(QtCore.QRect(350, 120, 320, 512))
        self.graphicsView_stroke.setObjectName("graphicsView_stroke")

        """self.graphicsView_sketch = QtWidgets.QGraphicsView(Form)
        self.graphicsView_sketch.setGeometry(QtCore.QRect(20, 120, 512, 512))
        self.graphicsView_sketch.setObjectName("graphicsView_sketch")"""

        self.graphicsView_2 = QtWidgets.QGraphicsView(Form)
        self.graphicsView_2.setGeometry(QtCore.QRect(790, 120,320, 512))
        ...
        self.pushButton_12.clicked.connect(Form.sketch_more_mode)

        self.pushButton_11.clicked.connect(Form.convert)
        self.pushButton_10.clicked.connect(Form.paste)
        # 应该是capture
        self.pushButton_9.clicked.connect(Form.ROI)
        self.pushButton_8.clicked.connect(Form.clear)
        self.pushButton_6.clicked.connect(Form.undo)
        self.pushButton_13.clicked.connect(Form.stroke_more_mode)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "fashion editing"))
        ...
        self.pushButton_9.setText(_translate("Form", "capture"))
        self.pushButton_10.setText(_translate("Form", "paste"))
        self.pushButton_11.setText(_translate("Form", "convert"))
        self.pushButton_12.setText(_translate("Form", "sketch_more"))
        self.pushButton_13.setText(_translate("Form", "stroke_more"))
